...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        return await query.answer("OKdaa 😎", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
    ...
    btn.insert(0, [
        InlineKeyboardButton(text="⚠️ MAIN CHANNEL ⚠️", url="https://t.me/movieempirev3")
    ])
    try:
...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('♻️ Please Check Movie Spelling ♻️ Check In Google ➡️ https://www.google.co.in/')
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('✳️ USE ME ✳️', url=f'http://t.me/{temp.U_NAME}?startgroup=true')
            ],[
            InlineKeyboardButton('💠 CHANNEL 💠', url='https://t.me/movieempirev3'),
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('🌴 BOT CHANNEL 🌴', url='https://t.me/meadwaidh_bots'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton(text="⚠️ ME ADWAIDH BOTS ⚠️", url="https://t.me/meadwaidh_bots")
    ])
